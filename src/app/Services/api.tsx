...
export const adminEquipmentStudents='/api/admin/equipments/students'
export const adminEquipmentReceipts='/api/admin/equipments/receipts'
...
export const studentCoursesGrades='/api/student/courses/grades'
