    ...
    return (
        <>
            <div className=' lg:flex lg:justify-center lg:items-center lg:h-fit'>
                <div className='w-full lg:w-[90%] lg:justify-center h-fit lg:h-full flex flex-col pt-4 pb-4 md:pr-4 gap-4 lg:gap-7 md:pl-4'>
                    <section className='border border-(--border-color) rounded-lg p-4 md:p-7 shadow-lg bg-green-50'>
                        <div className='flex items-center gap-4'>
                            <div className='relative w-25 h-25 rounded-full border flex items-center justify-center border-(--border-color)'>
                                <img src="avatarDefault.svg" alt="profile" className="w-15 h-15 " />
                            </div>
                            <span>
                                <span>fullname</span>
                                <div>Ngày sinh</div>
