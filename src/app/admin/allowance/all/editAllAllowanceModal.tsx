...
interface EditAllowanceModalProps {
    readonly data: AllowanceStudent;
    readonly showEdit: boolean;
    readonly setShowEdit: React.Dispatch<React.SetStateAction<boolean>>;
    readonly setDatas?: React.Dispatch<React.SetStateAction<AllowanceStudent[]>>;
}
                    ...
                    <div className="bg-green-50 rounded-xl p-4 mb-4">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="text-left">
                                ...
                                <p className="text-gray-500 text-sm">{data.studentEmail}</p>
                            </div>
                        </div>
                    </div>
